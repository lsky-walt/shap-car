        ...
        <div className="list-item" onClick={this.handleClick}>
          <div>
            <img
              ...
              data-src={require(`@/static/products/${sku}_1.jpg`).default}
            ></img>
          </div>
          ...
          <div className="price">
            <div>
              ...
              <b className="item-zoom-in">{Math.floor(price / 100)}</b>
              <span className="item-zoom-out">
                .{price % 100 === 0 ? "00" : price % 100}
              </span>
              <div className="item-inst">
                {installments && installments > 0 ? (
                  <>
                    ...
                    <b>
                      {currencyFormat}
                      {formatCurrency(price / installments)}
                    </b>
                  </>
                ) : null}
              </div>
